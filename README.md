...
1. Create python 3.10 conda environment: `mamba create --name fix_droid python=3.10`
2. Activate the conda environment: `mamba activate fix_droid`
3. Install [octo](https://github.com/octo-models/octo/tree/main), pinned at commit `85b83fc19657ab407a7f56558a5384ae56fe453b` (used for data loading): `pip install git+https://github.com/octo-models/octo.git@85b83fc19657ab407a7f56558a5384ae56fe453b`
